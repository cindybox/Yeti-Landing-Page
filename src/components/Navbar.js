...
const NavbarContainer = styled.nav`
  ...
  align-items: center;
  padding: 1.6rem 9%;
  background-color: var(--main-white, white);
  z-index: 4;
  ...
  .navbar-right li:nth-of-type(1n) {
    font-family: var(--nav-fontfamily);
    font-size: var(--nav-fontsize, 12px);
    font-weight: 500;
    line-height: 1.58;
    letter-spacing: 3px;
    color: var(--main-dark);
  }
  .navbar-right li:nth-of-type(2n) {
    padding-left: 14px;
  }
  ...
  .menu-icon svg path {
    stroke: ${(props) => props.menuOpen && "var(--main-white)"};
  }

  .menu-icon svg:hover path {
